---
description: Here you can find links to all the documented code blocks.
layout:
  title:
    visible: true
  description:
...
There are various pages for code blocks. You can find them below.

## Actions

#### General

* [Set Object Property](actions/general/set-object-property.md)
* [Get Object Property](actions/general/get-object-property.md)
* [Tween Object Property](actions/general/tween-object-property.md)
* [Create Object](actions/general/create-object.md)
...
* [Find First Child](actions/hierarchy/find-first-child.md)
* [Find First Child Which IsA](actions/hierarchy/find-first-child-which-isa.md)
* [Find First Child Of Class](actions/hierarchy/find-first-child-of-class.md)
* [Wait For Child](actions/hierarchy/wait-for-child.md)
* [Get Random Child](actions/hierarchy/get-random-child.md)
* [Get Children](actions/hierarchy/get-children.md)
* [Get Descendants](actions/hierarchy/get-descendants.md)
* [Is Descendant Of](actions/hierarchy/is-descendant-of.md)
* [Is Ancestor Of](actions/hierarchy/is-ancestor-of.md)
...
* [Find Parts In Region](actions/physics/find-parts-in-region.md)
...
* [Is Touching](actions/physics/is-touching.md)
* [Get Touching Parts](actions/physics/get-touching-parts.md)
* [Get Connected Parts](actions/physics/get-connected-parts.md)
* [Register Collision Group](actions/physics/register-collision-group.md)
* [Assign Collision Group](actions/physics/assign-collision-group.md)
* [Collision Group Set Collidable](actions/physics/collision-group-set-collidable.md)

#### Models

* [Move Model To](actions/models/move-model-to.md)
* [Set Model PrimaryPart CFrame](actions/models/set-model-primarypart-cframe.md)
* [Get Model Bounding Box](actions/models/get-model-bounding-box.md)

#### Sounds

* [Play Sound](actions/sounds/play-sound.md)
* [Stop Sound](actions/sounds/stop-sound.md)
* [Pause Sound](actions/sounds/pause-sound.md)
* [Resume Sound](actions/sounds/resume-sound.md)

#### Leaderstats

* [Create Leaderstat](actions/leaderstats/create-leaderstat.md)
* [Get Leaderstat](actions/leaderstats/get-leaderstat.md)
* [Set Leaderstat](actions/leaderstats/set-leaderstat.md)
* [Add to Leaderstat](actions/leaderstats/add-to-leaderstat.md)
* [Leaderstat Changed](actions/leaderstats/leaderstat-changed.md)

#### GUI

* [Tween GUI Size](actions/gui/tween-gui-size.md)
* [Tween GUI Position](actions/gui/tween-gui-position.md)
* [Set Core GUI Enabled](actions/gui/set-core-gui-enabled.md)
* [Focus on TextBox](actions/gui/focus-on-textbox.md)
* [Unfocus on TextBox](actions/gui/unfocus-on-textbox.md)

#### Players

* [Get Player From Character](actions/players/get-player-from-character.md)
* [Get Players On Team](actions/players/get-players-on-team.md)
* [Get User ID From Name](actions/players/get-userid-from-name.md)
* [Get Name From User ID](actions/players/get-name-from-userid.md)
* [Set Camera Position](actions/players/set-camera-position.md)
* [Get Camera Position](actions/players/get-camera-position.md)
* [Kick Player](actions/players/kick-player.md)
* [Ban Player](actions/players/ban-player.md)
* [Mute Player](actions/players/mute-player.md)
* [Teleport To Place](actions/players/teleport-to-place.md)
* [Teleport To Owned Place](actions/players/teleport-to-owned-place.md)
* [Give Badge](actions/players/give-badge.md)
* [Has Badge](actions/players/has-badge.md)
* [Has Gamepass](actions/players/has-gamepass.md)
* [Set Mouse Icon](actions/players/set-mouse-icon.md)
...
* [While Loop](miscellaneous/loops/while-loop.md)
* [Loop Through Table](miscellaneous/loops/loop-through-table.md)
* [Loop Through Children](miscellaneous/loops/loop-through-children.md)
* [Loop Through Descendants](miscellaneous/loops/loop-through-descendants.md)
